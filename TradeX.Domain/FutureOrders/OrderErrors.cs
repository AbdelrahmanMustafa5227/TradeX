...
namespace TradeX.Domain.FutureOrders
{
    public static class OrderErrors
    {
        ...
        public static readonly Error OrderNotFound = new Error("Order", "Inactive orders cannot be closed");

        public static readonly Error InvalidExitPrice = new Error("Order", "Invalid Short Order Price");

        public static readonly Error InvalidEntryPrice = new Error("Order", "Invalid Short Order Price");
